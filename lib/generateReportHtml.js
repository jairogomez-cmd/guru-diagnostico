...
function moduloPublicidad(d) {
  ...
  if (pt.posibleTagOcultoEnGTM || pt.posiblePixelOcultoEnGTM) {
    ...
    items.push({ tipo: 'warn', texto: `Tenés Google Tag Manager activo, así que es posible que ${esc(cuales)} esté configurado ahí adentro sin que se vea desde acá — confirmalo directo en tu cuenta de Tag Manager o preguntale a tu asesor.` });
  }
