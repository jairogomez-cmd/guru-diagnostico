...
function saludContenidoHtml(d) {
  ...
  return `<div class="module-card page-start">
    ...
    <div class="cq-cross"><strong>Esto también le importa a las IA:</strong> además de estos puntos, revisamos si tu sitio tiene <strong>datos estructurados (Schema)</strong>${ha.schemaLB ? ' <span style="color:var(--guru-teal)">✓ detectado</span>' : ' <span style="color:var(--guru-accent)">✗ no detectado</span>'} y si permite el acceso de los rastreadores de IA — ese detalle está en la sección de Presencia en Inteligencia Artificial de este informe.</div>
  </div>`;
}
