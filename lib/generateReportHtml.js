...
.module-card, .radar-item, .chart-box, .opp-card, .aiso-box, .questions-box, .detail-card, .hero, .comp-box, .op-headline-box, .op-ejemplo-box, .op-fuentes-box, .comp-insight-box {
