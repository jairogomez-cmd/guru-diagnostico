...
function plataformaIaCard(nombre, aparece, posicion, score, nota, fragmento, fuente, esEstimacion) {
  ...
  return `<div class="ia-card">
    ...
    ${fuente ? `<a class="ia-card-fuente" href="${esc(fuente)}" target="_blank" rel="noopener">Ver fuente citada ↗</a>` : ''}
...
.ad-creativo-media { width: 100%; height: 100px; flex-shrink: 0; background: #EEF0F5; display: flex; align-items: center; justify-content: center; overflow: hidden; }
.ad-creativo-media.screenshot { height: 150px; } /* las capturas de Google (anuncio + texto) necesitan más alto que una foto de Meta */
.ad-creativo-img { width: 100%; height: 100%; object-fit: cover; display: block; }
.ad-creativo-img.contain { object-fit: contain; background: #fff; } /* capturas de Google: se ven completas, sin recortar */
...
.ia-card-fuente { display: block; font-size: 10px; color: var(--guru-purple); text-decoration: none; margin-bottom: 10px; }
