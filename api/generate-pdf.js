...
async function handler(req, res) {
  ...
  try {
    ...
    const pdfBuffer = await page.pdf({
      ...
      margin: { top: '26px', bottom: '76px', left: '0px', right: '0px' },
      ...
      footerTemplate: `
        <div style="position:relative; width:100%; box-sizing:border-box; padding:0 40px; font-family:Arial,Helvetica,sans-serif;">
          <div style="text-align:center; padding-top:12px; font-size:8.5px; color:#94A3B8;">
            Guru Diagnóstico Digital &middot; Página <span class="pageNumber"></span> de <span class="totalPages"></span>
          </div>
          <div style="position:absolute; top:8px; right:40px; display:flex; align-items:center; background:#F3F1FF; border-radius:10px; padding:9px 16px; box-shadow:0 2px 6px rgba(108,99,255,.15);">
