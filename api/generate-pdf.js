...
async function handler(req, res) {
  ...
  try {
    ...
    const pdfBuffer = await page.pdf({
      ...
      margin: { top: '26px', bottom: '64px', left: '0px', right: '0px' },
      ...
      footerTemplate: `
        <div style="position:relative; width:100%; box-sizing:border-box; padding:0 40px; font-family:Arial,Helvetica,sans-serif;">
          ...
          <div style="position:absolute; top:6px; right:40px; display:flex; align-items:center; background:#F3F1FF; border-radius:8px; padding:6px 12px;">
